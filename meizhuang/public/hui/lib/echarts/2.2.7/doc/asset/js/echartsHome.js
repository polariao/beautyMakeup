    ...
    '<div class="container">'
        ...
        + '<div class="navbar-collapse collapse" id="nav-wrap">'
          + '<ul class="nav navbar-nav navbar-right" id="nav" style="max-width:100%;">'
            ...
            : ('<li class="' + (activeClass.index || '') + '"><a href="' + (loc.index || '.') + '/index.blade.php">首页</a></li>'
            ...
            + '<li class="dropdown ' + (activeClass.spreadsheet || '') + '">'
              ...
              + '<ul class="dropdown-menu">'
                ...
                + (enVersion ? '' : '<li><a target="_blank" href="http://study.163.com/category/courseMain.htm?courseId=1016007">视频教程</a></li>')
              + '</ul>'
            + '</li>'
            /*
            + '<li class="dropdown">'
            ...
            + '<div class="row" style="padding-bottom:20px;">'
                + '<div class="col-md-3">'
                    ...
                    + '<ul>'
                        ...
                        + '<li><a href="http://ecomfe.github.io/zrender/index.blade.php" target="_blank">ZRender</a></li>'
