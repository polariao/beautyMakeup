...
<div >
    ...
    <div class="page-container">
        <div class="text-c">
            <form action="{{url('admin/leaveword/select')}}" method="post">
                @csrf
                <input type="text" name="id"  placeholder="    昵称 / 标题" style="width:250px" class="input-text">
                <button   class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索留言</button>
            </form>
...
<script type="text/javascript">
    function delCate(id){
        layer.confirm('您确定删除吗？', {
            ...
            $.post("{{url('admin/leaveword/')}}/"+id ,{'_method':'delete','_token':"{{csrf_token()}}"},function (data) {
                if ((data.status==0)) {
