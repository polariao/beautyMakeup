            ...
            <table class="table table-border table-bordered table-bg table-hover table-sort">
                ...
                @foreach($data as $v)
                    <tr class="text-c">
                        ...
                        <td>{{$v->stu_wei}}</td>
                        <td>{{$v->stu_email}}</td>
                        <td class="td-manage"><a title="编辑" href="{{url('admin/student/'.$v->stu_id.'/edit')}}" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> &nbsp;&nbsp;&nbsp;&nbsp;
                            <a title="删除" href="javascript:;" onclick="delCate({{$v->stu_id}})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
