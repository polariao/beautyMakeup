...
<div class="page-container">
    <form enctype="multipart/form-data" action="{{url('admin/protocol/store')}}" method="post" class="form form-horizontal" id="form-article-add" >
        @csrf
        ...
        <div class="row cl">
            <h2 style="text-align: center"> 商城协议</h2>
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <div class="row cl">
                    ...
                    <input style="margin-left:400px" class="btn btn-primary radius" value="确认修改" type="submit"></input>
                    </div>
                    </div>
                    </form>
                    </div>
