...
<div class="page-container">
    <form enctype="multipart/form-data" action="{{url('admin/product')}}" method="post" class="form form-horizontal" id="form-article-add" >
        @csrf
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="spmingcheng">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="xinghao">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>品牌：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="pinpai">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">会员价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="huiyuanjia" id="" placeholder="" value="" class="input-text" style="width:10%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">市场价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input  type="text" name="shichangjia" id="" placeholder="" value="" class="input-text" style="width:10%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">成本价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="chengben" id="" placeholder="" value="" class="input-text" style="width:10%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">库存量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" name="shuliang" id="" placeholder="" value="" class="input-text" style="width:10%">
                </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="time" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'datemin\')}' })" id="datemax" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="file" multiple name="tupian" class="input-file">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" name="spjianjie" type="text/plain"  style="width:100%;height:400px;"></script>
                </div>
                </div>
                <div class="row cl">
