...
<head>
    ...
    <link href="{{asset('./hui/lib/webuploader/0.1.5/webuploader.css')}}" rel="stylesheet" type="text/css" />
</head>
<body>

<div class="page-container">
    <form enctype="multipart/form-data" action="{{url('admin/product/'.$editId->id)}}" method="post" class="form form-horizontal" id="form-article-add" >
        @csrf
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$editId->spmingcheng}}" placeholder="" id="" name="spmingcheng">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="spdengji" class="select" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$editId->xinghao}}" placeholder="" id="" name="xinghao">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>品牌：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$editId->pinpai}}" placeholder="" id="" name="pinpai">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">会员价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="huiyuanjia" id="" placeholder="" value="{{$editId->huiyuanjia}}" class="input-text" style="width:10%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">市场价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input  type="text" name="shichangjia" id="" placeholder="" value="{{$editId->shichangjia}}" class="input-text" style="width:10%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">成本价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="chengben" id="" placeholder="" value="{{$editId->chengben}}" class="input-text" style="width:10%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">库存量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" name="shuliang" id="" placeholder="" value="{{$editId->shuliang}}" class="input-text" style="width:10%">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"></label>
            <div class="formControls col-xs-8 col-sm-9">
                <input  type="hidden" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">上架时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" value="{{$editId->time}}" name="time" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'datemin\')}' })" id="datemax" class="input-text Wdate" style="width:180px;">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor"  name="spjianjie" type="text/plain"  style="width:100%;height:400px;">{!! $editId->spjianjie !!}</script>
                </div>
                </div>
                <div class="row cl">
                    <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    <input style="margin-left:300px" class="btn btn-primary radius" value="提交" type="submit"></input>
                    <input style="margin-left:50px" class="btn btn-default radius" type="reset"></input>
                    </div>
                    </div>
                    </form>
                    </div>
                ...
                <script type="text/javascript" src="{{asset('./hui/lib/webuploader/0.1.5/webuploader.min.js')}}"></script>
                <script type="text/javascript" src="{{asset('./hui/lib/ueditor/1.4.3/ueditor.config.js')}}"></script>
                <script type="text/javascript" src="{{asset('./hui/lib/ueditor/1.4.3/ueditor.all.min.js')}}"> </script>
                <script type="text/javascript" src="{{asset('./hui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js')}}"></script>
