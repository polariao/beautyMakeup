...
<div class="page-container">
    <form action="{{url('admin/gonggao/'.$data->id)}}" method="post" class="form form-horizontal" id="form-user-add">
        @csrf
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" value="{{$data->title}}" placeholder="" id="user-name" name="title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">简介：</label>
            <div class="formControls col-xs-6 col-sm-6">
                <textarea name="content" cols="" rows="" class="textarea"  placeholder="说点什么..." onKeyUp="$.Huitextarealength(this,100)">
                    {!! $data->content !!}
                </textarea>
            </div>
        </div>
