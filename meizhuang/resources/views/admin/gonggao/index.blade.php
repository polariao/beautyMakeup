    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td>{{$v->content}}</td>
                <td>{{$v->time}}</td>
                <td class="td-manage"><a title="编辑" href="{{url('admin/gonggao/'.$v->id.'/edit')}}" style="text-decoration:none"><i style="font-size: 20px" class="Hui-iconfont">&#xe6df;</i></a> &nbsp;&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    function delCate(id){
        layer.confirm('您确定删除吗？', {
            ...
            $.post("{{url('admin/gonggao/')}}/"+id ,{'_method':'delete','_token':"{{csrf_token()}}"},function (data) {
                if ((data.status==0)) {
